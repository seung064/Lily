...
using ProjectDB.Models; // 네임스페이스와 일치 (끌어오기)
...
namespace ProjectDB.Data
{
    ...
    public class AppDbContext : DbContext
    {
        ...
        // 모델에 대한 추가 설정이 필요할 경우 여기서 정의
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            // 예: Seed 데이터, Fluent API 설정 등
            ...
            modelBuilder.Entity<Ingredient>().HasData(
                new Ingredient { IngredientNum = 1, IngredientName = "암철석", Description_I = "무기 제작에 사용되는 고강도 금속 원석", CountryNum = 1 },
                new Ingredient { IngredientNum = 2, IngredientName = "진토금", Description_I = "고열을 견디는 귀금속, 전도성이 뛰어남", CountryNum = 1 },
                new Ingredient { IngredientNum = 3, IngredientName = "석기정", Description_I = "고대 생물의 화석에서 채굴되는 결정성 자원", CountryNum = 1 },
                new Ingredient { IngredientNum = 4, IngredientName = "심해석", Description_I = "깊은 해저에서 추출되는 희귀 금속", CountryNum = 2 },
                new Ingredient { IngredientNum = 5, IngredientName = "청류정수", Description_I = "정제된 고순도 수자원, 생명 유지나 에너지 전환에 사용", CountryNum = 2 },
                new Ingredient { IngredientNum = 6, IngredientName = "바다수정", Description_I = "수중 생명체 뼈대에서 채취한 반투명 결정체", CountryNum = 2 },
                new Ingredient { IngredientNum = 7, IngredientName = "풍정석", Description_I = "대기 중에서 응결되는 가벼운 결정, 부유 장치 제작에 활용", CountryNum = 3 },
                new Ingredient { IngredientNum = 8, IngredientName = "회오리 플라스크", Description_I = "고속 회전에너지로 저장된 압축 에너지 컨테이너", CountryNum = 3 },
                new Ingredient { IngredientNum = 9, IngredientName = "공명결정", Description_I = "대기 진동과 공명하는 음파 기반의 마력 결정", CountryNum = 3 },
                new Ingredient { IngredientNum = 10, IngredientName = "화염정광", Description_I = "용암 지대에서 채굴되는 고열 금속 결정", CountryNum = 4 },
                new Ingredient { IngredientNum = 11, IngredientName = "용석탄", Description_I = "천연 용암석으로 이루어진 고열 연료 자원", CountryNum = 4 },
                new Ingredient { IngredientNum = 12, IngredientName = "발화진주", Description_I = "마그마 생물의 분비물로 형성된 진귀한 에너지 진주", CountryNum = 4 }
            );
